...
while not gameExit:
	...
	#look up draw.rect()
	pygame.draw.rect(gameDisplay, black, [400,200, 10, 100])
	...
	pygame.draw.circle(gameDisplay, blue, (60,150), 40, 30)
	pygame.draw.rect(gameDisplay, green, [700,55, 100, 200])
	pygame.draw.rect(gameDisplay, green, [700,300, 100, 200])
